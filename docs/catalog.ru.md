...
Выбрав блюдо в дереве и нажав **Редактировать**, вы открываете форму редактирования со всеми
атрибутами блюда. Подробную информацию о продукте также можно найти в разделе
**Платформа (Platform)** -> **Продукты (Products)**.

<figure markdown="1">
  <div class="annotated-screenshot" data-annotation-config="../../screenshots/catalog_dish_edit.ru.annotate.yml" markdown="1">
![Форма редактирования блюда](screenshots/catalog_dish_edit.png){ loading=lazy }
  </div>
  <figcaption>Рисунок 3: Форма редактирования блюда — SKU, описание, название, SEO-метаданные и кнопка «Сохранить».</figcaption>
</figure>
